        ...
        <div className="container mx-auto px-4 pt-16 pb-24 sm:px-6 lg:px-8 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 animate-fade-in">
              <span className="px-3 py-1 text-sm bg-sage-100 text-sage-800 rounded-full inline-block mb-6 animate-slide-in opacity-0" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
              ...
              <p className="text-lg md:text-xl text-sage-700 mb-8 max-w-xl animate-slide-in opacity-0" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
                Simple steps to share what you're here to give.
              </p>
              
              <p className="text-lg text-sage-600 mb-8 max-w-xl animate-slide-in opacity-0" style={{ animationDelay: '0.9s', animationFillMode: 'forwards' }}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 animate-slide-in opacity-0" style={{ animationDelay: '1.2s', animationFillMode: 'forwards' }}>
                <Button
                  variant="primary"
                  size="lg"
                  className="group"
            ...
            <div className="order-1 md:order-2 flex justify-center">
              <div className="relative w-full max-w-md animate-float">
                ...
                <img
                  ...
                  alt="Aaron Gabriel in Boulder nature setting"
