...
const HeroSection = () => {
  ...
  return <section className="min-h-screen pt-16 relative flex items-center">
      <div className="container mx-auto px-4 pt-16 pb-24 sm:px-6 lg:px-8 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className={`${isMobile ? 'order-1' : 'order-2 md:order-1'} animate-fade-in`}>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-display font-semibold tracking-tight text-sage-900 mb-6 flowing-border pb-2">Express Your Essence</h1>
